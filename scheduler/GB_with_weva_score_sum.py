...
class GB_with_Weva_Score_Sum(SchedulerBase):
    ...
    def adjustLR(self, weva_table, init_diff_table, lr_table, n_epoch, param_num_list):
        ...
        target_lr = self.lr_manager.cal_target_lr(now_weva, now_lr, target_weva, self.cls_lr, n_epoch)
    ...
    def try_lr_update(self, weva_try):
        ...
        if check_GB:
            ...
            Trial_error = True
        return Trial_error, init_score, target_weva
    ...
    def condition_bound_update(self, weva_try, weva_target):
        self.condition_manager.adjust_bound(weva_try, weva_target)