...
class Auto_Start_GB_Score_Trainer(TrainerBase):
    ...
    def train_model(self, epochs, init_lr):
        ...
        lr_scheduler = LRS_GB_Score(self.model, self.model_name, init_lr, self.thr_init_score, self.K, self.scale_factor, self.bound, self.min_f, self.max_f) #TODO instance arg_parser
